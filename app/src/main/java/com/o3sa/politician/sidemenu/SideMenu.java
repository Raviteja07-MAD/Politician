...
import com.o3sa.politician.partymember_fragments.Areaslist;
...
import com.o3sa.politician.partymember_fragments.Settings;
...
public class SideMenu extends AppCompatActivity {
        ...
        layout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (type.equalsIgnoreCase("0")) {
                    ...
                    fragmentcallinglay(new Profile_partymember());
                }
            }
        });
    }
    ...
    public void backbuttonclickevents() {
        ...
        if (StoredObjects.page_type.equalsIgnoreCase("admnprfile")) {
            ...
            buttonchangemethod(SideMenu.this, btm_profile_lay, btm_profile_img, btm_profile_txt, "4");
        }
...
*/
       ...
       /* if (StoredObjects.page_type.equalsIgnoreCase("evnts")) {
        ...
        if (StoredObjects.page_type.equalsIgnoreCase("cratearea")) {
