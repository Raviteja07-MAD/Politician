...
public class Followers extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        StoredObjects.page_type = "folwers";

        StoredObjects.back_type = "folwers";
    ...
    private void initilization(View v) {
        ...
        customRecyclerview.Assigndatatorecyleviewhashmap(profile_following_recyclerview, setngs_profilelist,"Followers", StoredObjects.Listview, 0, StoredObjects.ver_orientation, R.layout.followers_list);
    }
