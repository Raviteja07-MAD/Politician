...
import static com.o3sa.politician.sidemenu.SideMenu.list_slidermenu_lay;
import static com.o3sa.politician.sidemenu.SideMenu.mDrawerLayout;
...
public class Home extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        buttonchangemethod(getActivity(), btm_log_catch_lay, btm_log_catch_img, btm_log_catch_txt, "0");
