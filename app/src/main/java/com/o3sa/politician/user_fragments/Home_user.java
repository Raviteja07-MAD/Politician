...
public class Home_user extends Fragment {
    ...
    LinearLayout nodatafound_lay,followers_lay,following_lay,members_lay,donatn_lay,top_lay_home;
    ...
    private void initilization(View v) {
        ...
        top_lay_home = v.findViewById( R.id.top_lay_home );

        following_lay.setVisibility(View.GONE);
        followers_lay.setVisibility(View.GONE);
        members_lay.setVisibility(View.GONE);
        donatn_lay.setVisibility(View.GONE);
        top_lay_home.setVisibility(View.GONE);
        ...
        custm_menu_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawablecount++;
                if (drawablecount == 1) {
                    SideMenu_user.mDrawerLayout.openDrawer(SideMenu_user.list_slidermenu_lay);
                } else {
                    drawablecount = 0;
                    SideMenu_user.mDrawerLayout.closeDrawer(SideMenu_user.list_slidermenu_lay);
                }
            }
