...
public class Events_user extends Fragment {
    ...
    private void init(View v) {
        ...
        customRecyclerview.Assigndatatorecyleviewhashmap(kidpick_recycle, StoredObjects.dummy_list,"evntslist_user", StoredObjects.Listview,0, StoredObjects.ver_orientation, R.layout.eventlisitem);
